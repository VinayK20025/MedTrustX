"""
Clinical Service Main Application.
"""
...
from app.routers import vitals, conditions, medications, orders, results, referrals, careplans, cds, websocket
...
app = FastAPI(
    title="MedTrustX Clinical Service",
    lifespan=lifespan
)
