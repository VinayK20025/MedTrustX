"""
MedTrustX Forensic Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.forensic.events"


class ForensicEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=ForensicEventEncoder).encode("utf-8"),
