...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'for_resource';
    if (request.path.includes('/forensic/cases')) resource = 'for_cases';
    else if (request.path.includes('/evidence')) resource = 'for_evidence';
    else if (request.path.includes('/custody-logs')) resource = 'for_custody';
    else if (request.path.includes('/forensic-reports')) resource = 'for_reports';
    else if (request.path.includes('/external-requests')) resource = 'for_requests';
