"""
MedTrustX Access Review Service — Application Entrypoint
"""
import time
...
REQUEST_COUNT = Counter(
    "access_review_requests_total",
    "Total HTTP requests", ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "access_review_request_duration_seconds",
...
app = FastAPI(
    title="MedTrustX Access Review Service",
    description="Governance and continuous access validation.",
...
from src.routes.certify import router as certify_router
from src.routes.anomalies import router as anomalies_router
from src.routes.revoke import router as revoke_router

app.include_router(health_router, tags=["Health"])
app.include_router(campaigns_router, prefix="/api/v1")
app.include_router(certify_router, prefix="/api/v1")
