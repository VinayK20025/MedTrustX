"""
MedTrustX Access Review Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.access_review.events"

class ReviewEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=ReviewEventEncoder).encode("utf-8"),
