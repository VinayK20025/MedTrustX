"""
MedTrustX Kong Gateway Shim Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.gateway.events"


class GatewayEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=GatewayEventEncoder).encode("utf-8"),
