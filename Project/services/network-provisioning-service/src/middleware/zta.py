...
_RESOURCE_MAP = {"/networks": "provisioning_networks", "/subnets": "provisioning_subnets", "/ip/allocate": "provisioning_ip_allocations", "/devices": "provisioning_network_devices"}
