"""
MedTrustX PAM Service — Application Entrypoint
"""
import time
...
app = FastAPI(
    ...
    description="Privileged Access Management for high-risk operations.",
...
# Add pam/request-access alias route to requests router
@requests_router.post("/request-access", include_in_schema=False)
async def alias_request_access(data, request: Request, session=Depends(get_session)):
    from src.routes.requests import request_access
    return await request_access(data, request, session)
