...
_RESOURCE_MAP = {
    "/pam/request-access": "pam_request",
    "/pam/requests": "pam_request",
    "/pam/approve": "pam_approval",
    "/pam/reject": "pam_approval",
    "/pam/start-session": "pam_session",
    "/pam/end-session": "pam_session",
    "/pam/sessions": "pam_session",
    "/pam/accounts": "pam_account",
}
