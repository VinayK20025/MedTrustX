"""
MedTrustX PAM Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.pam.events"

class PAMEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=PAMEventEncoder).encode("utf-8"),
