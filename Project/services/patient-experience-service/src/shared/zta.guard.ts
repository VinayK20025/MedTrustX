...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'px_resource';
    if (request.path.includes('/feedback')) resource = 'px_feedback';
    else if (request.path.includes('/surveys')) resource = 'px_surveys';
    else if (request.path.includes('/survey-responses')) resource = 'px_responses';
    else if (request.path.includes('/complaints')) resource = 'px_complaints';
    else if (request.path.includes('/experience-scores')) resource = 'px_scores';
