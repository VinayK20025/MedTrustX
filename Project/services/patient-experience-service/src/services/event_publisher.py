"""
MedTrustX Patient Experience Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.experience.events"


class ExperienceEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=ExperienceEventEncoder).encode("utf-8"),
