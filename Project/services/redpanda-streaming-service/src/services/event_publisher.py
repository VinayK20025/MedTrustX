"""
MedTrustX Redpanda Streaming Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.streaming.events"


class StreamingEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=StreamingEventEncoder).encode("utf-8"),
