"""
MedTrustX Medical Records Service — Configuration
"""
...
class Settings(BaseSettings):
    ...
    DB_PORT: int = 5432
    DB_USER: str = "records_svc"
    DB_PASSWORD: str = "records_svc_secret"
    DB_NAME: str = "records_db"
    ...
    MINIO_BUCKET: str = "medical-records"
