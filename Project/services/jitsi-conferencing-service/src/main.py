"""
MedTrustX Jitsi Conferencing Service — Application Entrypoint
"""
import time
...
REQUEST_COUNT = Counter("jitsi_requests_total", "Total HTTP requests", ["method", "endpoint", "status"])
REQUEST_LATENCY = Histogram("jitsi_request_duration_seconds", "Request latency in seconds", ["method", "endpoint"])
...
app = FastAPI(
    title="MedTrustX Jitsi Conferencing Service",
    description="Real-time video conferencing for telehealth and collaboration.",
...
from src.routes.jitsi import router as jitsi_router
