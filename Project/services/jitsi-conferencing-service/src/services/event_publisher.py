"""
MedTrustX Jitsi Conferencing Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.jitsi.events"


class JitsiEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=JitsiEventEncoder).encode("utf-8"),
