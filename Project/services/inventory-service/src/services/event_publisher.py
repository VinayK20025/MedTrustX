"""
MedTrustX Inventory Service — Event Publisher

Publishes Inventory lifecycle events to Redpanda/Kafka.
...
TOPIC = "medtrust.inventory.events"
...
async def publish_event(
    ...
    try:
        routing_key = str(item_id) if item_id else str(tenant_id)
