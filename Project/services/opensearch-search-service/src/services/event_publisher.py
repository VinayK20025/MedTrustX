"""
MedTrustX OpenSearch Search Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.search.events"


class SearchEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=SearchEventEncoder).encode("utf-8"),
