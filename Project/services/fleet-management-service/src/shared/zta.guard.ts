...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'fm_resource';
    if (request.path.includes('/vehicles')) resource = 'fm_vehicles';
    else if (request.path.includes('/drivers')) resource = 'fm_drivers';
    else if (request.path.includes('/trips')) resource = 'fm_trips';
    else if (request.path.includes('/assignments')) resource = 'fm_assignments';
