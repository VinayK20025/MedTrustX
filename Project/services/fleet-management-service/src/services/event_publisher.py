"""
MedTrustX Fleet Management Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.fleet.events"


class FleetEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=FleetEventEncoder).encode("utf-8"),
