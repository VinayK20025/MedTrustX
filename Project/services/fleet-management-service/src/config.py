"""
MedTrustX Fleet Management Service — Configuration
...
class Settings(BaseSettings):
    ...
    DB_PORT: int = 5432
    DB_USER: str = "fleet_svc"
    DB_PASSWORD: str = "fleet_svc_secret"
    DB_NAME: str = "fleet_db"
    ...
    REDIS_URL: str = "redis://redis:6379/58"
