"""
MedTrustX Vault Shim Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.vault.events"

class VaultEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=VaultEventEncoder).encode("utf-8"),
