"""
MedTrustX Blood Bank Service — Event Publisher

Publishes safety-critical events to Redpanda/Kafka.
...
TOPIC = "medtrust.bloodbank.events"
...
async def publish_event(
    ...
    try:
        # Key by patient_id if available to guarantee event ordering for the same patient
