"""
MedTrustX Operational Command Center Service — Application Entrypoint
"""
import time
...
REQUEST_COUNT = Counter("command_center_requests_total", "Total HTTP requests", ["method", "endpoint", "status"])
REQUEST_LATENCY = Histogram("command_center_request_duration_seconds", "Request latency in seconds", ["method", "endpoint"])
...
app = FastAPI(
    title="MedTrustX Operational Command Center Service",
    description="Tier-0 centralized operational control and incident coordination.",
...
from src.routes.command_center import router as cmd_router
