"""
MedTrustX Operational Command Center Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.commandcenter.events"


class CmdEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=CmdEventEncoder).encode("utf-8"),
