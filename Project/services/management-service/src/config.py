"""
MedTrustX Management Service — Configuration
...
class Settings(BaseSettings):
    ...
    LOG_LEVEL: str = "debug"
    SERVICE_NAME: str = "management-service"
    SERVICE_VERSION: str = "1.0.0"

    DB_HOST: str = "pg-operational"
    DB_PORT: int = 5432
    DB_USER: str = "mgmt_svc"
    DB_PASSWORD: str = "mgmt_svc_secret"
    DB_NAME: str = "mgmt_db"
    ...
    REDIS_URL: str = "redis://redis:6379/18"
