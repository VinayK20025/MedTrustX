"""
MedTrustX Management Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.management.events"

class ManagementEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=ManagementEventEncoder).encode("utf-8"),
...
async def publish_event(
    ...
    try:
        ...
        await _producer.send_and_wait(topic=TOPIC, key=key, value=event)
