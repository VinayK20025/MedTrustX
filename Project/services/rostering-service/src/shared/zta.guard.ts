...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'ro_resource';
    if (request.path.includes('/schedules')) resource = 'ro_schedules';
    else if (request.path.includes('/shifts')) resource = 'ro_shifts';
    else if (request.path.includes('/assignments')) resource = 'ro_assignments';
    else if (request.path.includes('/availability')) resource = 'ro_availability';
    else if (request.path.includes('/leaves')) resource = 'ro_leaves';
