"""
MedTrustX Rostering Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.rostering.events"


class RosteringEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=RosteringEventEncoder).encode("utf-8"),
