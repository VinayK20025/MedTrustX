"""
MedTrustX Medical Education Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.education.events"


class EducationEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=EducationEventEncoder).encode("utf-8"),
