...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'education_resource';
    if (request.path.includes('/courses')) resource = 'education_courses';
    else if (request.path.includes('/lessons')) resource = 'education_lessons';
    else if (request.path.includes('/assessments')) resource = 'education_assessments';
    else if (request.path.includes('/certifications')) resource = 'education_certifications';
    else if (request.path.includes('/enroll')) resource = 'education_enrollments';
