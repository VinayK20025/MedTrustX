...
Resource mapping for Bed Management service:
  - bed              → Bed inventory CRUD
  - bed_allocation   → Patient-to-bed assignment
  - bed_reservation  → Pre-booking for incoming patients
  - bed_transfer     → Patient bed-to-bed moves
  - bed_availability → Capacity dashboard reads
"""
...
_RESOURCE_MAP = {
    "/beds/availability": "bed_availability",
    "/beds": "bed",
    "/bed-allocations": "bed_allocation",
    "/bed-reservations": "bed_reservation",
    "/bed-transfers": "bed_transfer",
}
