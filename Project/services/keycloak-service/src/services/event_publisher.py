"""
MedTrustX Keycloak Shim Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.iam.events"  # Writing to IAM topic since Keycloak is part of IAM domain conceptually

class KeycloakEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=KeycloakEventEncoder).encode("utf-8"),
