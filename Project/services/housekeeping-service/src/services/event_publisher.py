"""
MedTrustX Housekeeping Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.housekeeping.events"


class HousekeepingEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=HousekeepingEventEncoder).encode("utf-8"),
