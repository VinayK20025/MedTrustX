"""
MedTrustX Vendor Management Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.vendor.events"


class VendorEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=VendorEventEncoder).encode("utf-8"),
