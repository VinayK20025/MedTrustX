...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'vm_resource';
    if (request.path.includes('/vendors')) resource = 'vm_vendors';
    else if (request.path.includes('/contracts')) resource = 'vm_contracts';
    else if (request.path.includes('/slas')) resource = 'vm_slas';
