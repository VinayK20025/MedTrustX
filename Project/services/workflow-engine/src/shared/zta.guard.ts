...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'we_resource';
    if (request.path.includes('/workflows')) resource = 'we_workflows';
    else if (request.path.includes('/workflow-definitions')) resource = 'we_definitions';
    else if (request.path.includes('/workflow-instances')) resource = 'we_instances';
    else if (request.path.includes('/tasks')) resource = 'we_tasks';
    else if (request.path.includes('/transitions')) resource = 'we_transitions';
