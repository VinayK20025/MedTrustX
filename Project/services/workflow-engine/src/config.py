"""
MedTrustX Workflow Engine — Configuration
...
class Settings(BaseSettings):
    ...
    DB_PORT: int = 5432
    DB_USER: str = "workflow_svc"
    DB_PASSWORD: str = "workflow_svc_secret"
    DB_NAME: str = "workflow_engine_db"
    ...
    REDIS_URL: str = "redis://redis:6379/52"
