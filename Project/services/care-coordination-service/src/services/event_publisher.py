"""
MedTrustX Care Coordination Service — Event Publisher

Publishes coordination events to Redpanda/Kafka.
...
TOPIC = "medtrust.coordination.events"
...
async def publish_event(
    ...
    if care_plan_id:
        event["care_plan_id"] = care_plan_id
    if payload:
        event["data"] = payload
    ...
    try:
        routing_key = str(care_plan_id) if care_plan_id else str(tenant_id)
