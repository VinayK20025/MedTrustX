"""
MedTrustX Data Governance Service — Configuration
...
class Settings(BaseSettings):
    ...
    DB_PORT: int = 5432
    DB_USER: str = "datagov_svc"
    DB_PASSWORD: str = "datagov_svc_secret"
    DB_NAME: str = "data_governance_db"
    ...
    REDIS_URL: str = "redis://redis:6379/50"
