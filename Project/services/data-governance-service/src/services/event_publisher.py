"""
MedTrustX Data Governance Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.data_governance.events"


class DGEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=DGEventEncoder).encode("utf-8"),
