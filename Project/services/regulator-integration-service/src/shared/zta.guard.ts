...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'ri_resource';
    if (request.path.includes('/regulators')) resource = 'ri_regulators';
    else if (request.path.includes('/reports')) resource = 'ri_reports';
    else if (request.path.includes('/submissions')) resource = 'ri_submissions';
    else if (request.path.includes('/acknowledgments')) resource = 'ri_acknowledgments';
