"""
MedTrustX Regulator Integration Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.regulator.events"


class RegulatorEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=RegulatorEventEncoder).encode("utf-8"),
