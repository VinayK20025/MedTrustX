...
_RESOURCE_MAP = {
    "/compliance/policies": "cg_policies",
    "/compliance/controls": "cg_controls",
    "/compliance/violations": "cg_violations",
    "/compliance/evidence": "cg_evidence",
    "/compliance/reports": "cg_reports",
}
