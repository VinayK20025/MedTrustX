...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'cg_resource';
    if (request.path.includes('/policies')) resource = 'cg_policies';
    else if (request.path.includes('/controls')) resource = 'cg_controls';
    else if (request.path.includes('/violations')) resource = 'cg_violations';
    else if (request.path.includes('/evidence')) resource = 'cg_evidence';
    else if (request.path.includes('/reports')) resource = 'cg_reports';
