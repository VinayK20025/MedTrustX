"""
MedTrustX Compliance Governance Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.compliance_governance.events"
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=CompEventEncoder).encode("utf-8"),
