"""
MedTrustX Case Management Service — Application Entrypoint
"""
import time
...
REQUEST_COUNT = Counter("case_requests_total", "Total HTTP requests", ["method", "endpoint", "status"])
REQUEST_LATENCY = Histogram("case_request_duration_seconds", "Request latency in seconds", ["method", "endpoint"])
...
app = FastAPI(
    title="MedTrustX Case Management Service",
    description="Complex patient cases, care plans, and longitudinal coordination.",
