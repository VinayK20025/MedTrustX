"""
MedTrustX Case Management Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.case.events"


class CaseEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=CaseEventEncoder).encode("utf-8"),
