"""
MedTrustX Insurance Integration Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.insurance.events"


class InsuranceEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=InsuranceEventEncoder).encode("utf-8"),
