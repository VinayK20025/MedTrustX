...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'ii_resource';
    if (request.path.includes('/insurance/eligibility')) resource = 'ii_eligibility';
    else if (request.path.includes('/insurance/preauth')) resource = 'ii_preauth';
    else if (request.path.includes('/insurance/claims')) resource = 'ii_claims';
    else if (request.path.includes('/insurance/remittances')) resource = 'ii_remittances';
