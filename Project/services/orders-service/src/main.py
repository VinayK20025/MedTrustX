"""
MedTrustX Orders Service — Application Entrypoint
"""
import time
...
REQUEST_COUNT = Counter(
    "orders_service_requests_total",
    "Total HTTP requests", ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "orders_service_request_duration_seconds",
...
app = FastAPI(
    title="MedTrustX Orders Service",
    description="Central orchestration layer for all clinical and operational orders within the hospital.",
