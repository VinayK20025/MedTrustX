"""
MedTrustX Orders Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.order.events"

class OrderEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=OrderEventEncoder).encode("utf-8"),
