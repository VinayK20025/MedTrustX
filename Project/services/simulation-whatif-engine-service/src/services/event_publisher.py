"""
MedTrustX Simulation & What-If Engine Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.simulation.events"


class SimEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=SimEventEncoder).encode("utf-8"),
