"""
MedTrustX HR Service — Event Publisher

Publishes HR lifecycle events to Redpanda/Kafka.
...
async def publish_event(
    ...
    try:
        routing_key = str(employee_id) if employee_id else str(tenant_id)
