"""
MedTrustX Access Control Service — Event Publisher
"""
import json
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=AccessEventEncoder).encode("utf-8"),
