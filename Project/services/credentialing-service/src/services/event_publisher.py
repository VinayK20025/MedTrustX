"""
MedTrustX Credentialing Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.credentialing.events"


class CredEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=CredEventEncoder).encode("utf-8"),
