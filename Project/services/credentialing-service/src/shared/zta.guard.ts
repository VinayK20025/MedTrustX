...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'cred_resource';
    if (request.path.includes('/credentials')) resource = 'cred_credentials';
    else if (request.path.includes('/privileges')) resource = 'cred_privileges';
    else if (request.path.includes('/privileging-requests')) resource = 'cred_privileging_requests';
    else if (request.path.includes('/verify')) resource = 'cred_verifications';
