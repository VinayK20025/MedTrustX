"""
MedTrustX AI Platform Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.ai.events"


class AIEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=AIEventEncoder).encode("utf-8"),
