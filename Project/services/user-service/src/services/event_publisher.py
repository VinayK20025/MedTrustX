"""
MedTrustX User Management Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.user.events"

class UserEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=UserEventEncoder).encode("utf-8"),
