"""
MedTrustX MPI Service — Application Entrypoint
"""
import time
...
app = FastAPI(
    title="MedTrustX MPI Service",
    description="Identity resolution and deduplication engine.",
...
from src.routes.mpi import router as mpi_router
from src.routes.matching import router as matching_router

app.include_router(health_router, tags=["Health"])
app.include_router(mpi_router, prefix="/api/v1")
