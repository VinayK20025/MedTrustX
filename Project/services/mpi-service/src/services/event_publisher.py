"""
MedTrustX MPI Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.mpi.events"

class MPIEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=MPIEventEncoder).encode("utf-8"),
