"""
MedTrustX Consent Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.consent.events"

class ConsentEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=ConsentEventEncoder).encode("utf-8"),
