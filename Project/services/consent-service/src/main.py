"""
MedTrustX Consent Service — Application Entrypoint
"""
import time
...
REQUEST_LATENCY = Histogram(
    "consent_request_duration_seconds",
...
app = FastAPI(
    title="MedTrustX Consent Service",
    description="Consent Lifecycle and Validation.",
...
async def metrics_middleware(request: Request, call_next):
    ...
    if "/consents" in path or "/patients" in path:
        parts = path.split("/")
        normalized = []
        for part in parts:
            try:
