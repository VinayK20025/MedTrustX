"""
MedTrustX Consent Service — Configuration
...
class Settings(BaseSettings):
    ...
    DB_PORT: int = 5432
    DB_USER: str = "consent_svc"
    DB_PASSWORD: str = "consent_svc_secret"
    DB_NAME: str = "consent_db"
    ...
    REDIS_URL: str = "redis://redis:6379/30"
