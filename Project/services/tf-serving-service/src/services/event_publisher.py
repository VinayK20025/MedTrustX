"""
MedTrustX TF Serving Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.tfserving.events"


class TFServingEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=TFServingEventEncoder).encode("utf-8"),
