...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'qm_resource';
    if (request.path.includes('/quality')) resource = 'qm_metrics';
    else if (request.path.includes('/incidents')) resource = 'qm_incidents';
    else if (request.path.includes('/audits')) resource = 'qm_audits';
    else if (request.path.includes('/improvement-plans')) resource = 'qm_improvement_plans';
