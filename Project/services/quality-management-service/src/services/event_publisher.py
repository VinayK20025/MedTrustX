"""
MedTrustX Quality Management Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.quality.events"


class QualityEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=QualityEventEncoder).encode("utf-8"),
