"""
MedTrustX Jaeger Tracing Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.tracing.events"


class TracingEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=TracingEventEncoder).encode("utf-8"),
