"""
MedTrustX Notification Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.notification.events"

class NotificationEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=NotificationEventEncoder).encode("utf-8"),
