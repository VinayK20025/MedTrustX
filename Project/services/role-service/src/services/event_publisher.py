"""
MedTrustX Role Management Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.role.events"

class RoleEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=RoleEventEncoder).encode("utf-8"),
