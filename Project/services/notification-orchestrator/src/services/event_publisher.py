"""
MedTrustX Notification Orchestrator Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.notification_orchestrator.events"

class OrchestratorEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=OrchestratorEventEncoder).encode("utf-8"),
