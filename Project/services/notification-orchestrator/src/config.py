"""
MedTrustX Notification Orchestrator Service — Configuration
...
class Settings(BaseSettings):
    ...
    DB_PORT: int = 5432
    DB_USER: str = "notif_orch_svc"
    DB_PASSWORD: str = "notif_orch_svc_secret"
    DB_NAME: str = "notif_orch_db"
    ...
    REDIS_URL: str = "redis://redis:6379/17"
