"""
MedTrustX Redpanda Console Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.console.events"


class ConsoleEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=ConsoleEventEncoder).encode("utf-8"),
