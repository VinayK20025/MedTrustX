"""
MedTrustX Digital Twin Engine Service — Configuration
...
class Settings(BaseSettings):
    ...
    LOG_LEVEL: str = "debug"
    SERVICE_NAME: str = "digital-twin-engine-service"
    SERVICE_VERSION: str = "1.0.0"

    DB_HOST: str = "pg-operational"
    DB_PORT: int = 5432
    DB_USER: str = "twin_svc"
    DB_PASSWORD: str = "twin_svc_secret"
    DB_NAME: str = "twin_db"
    ...
    REDIS_URL: str = "redis://redis:6379/85"
