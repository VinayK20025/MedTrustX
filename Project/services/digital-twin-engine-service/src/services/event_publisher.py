"""
MedTrustX Digital Twin Engine Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.digitaltwin.events"


class TwinEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=TwinEventEncoder).encode("utf-8"),
