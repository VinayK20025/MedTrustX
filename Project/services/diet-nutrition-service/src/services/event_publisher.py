"""
MedTrustX Diet & Nutrition Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.diet.events"


class DietEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=DietEventEncoder).encode("utf-8"),
