...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'diet_resource';
    if (request.path.includes('/diet-plans')) resource = 'diet_plans';
    else if (request.path.includes('/nutrition-profiles')) resource = 'diet_profiles';
    else if (request.path.includes('/meal-orders')) resource = 'diet_orders';
    else if (request.path.includes('/diet-events')) resource = 'diet_events';
