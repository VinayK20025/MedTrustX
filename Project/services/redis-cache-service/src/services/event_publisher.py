"""
MedTrustX Redis Cache Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.cache.events"


class CacheEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=CacheEventEncoder).encode("utf-8"),
