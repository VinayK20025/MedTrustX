"""
MedTrustX ClickHouse Analytics Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.analytics.events"


class AnalyticsEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=AnalyticsEventEncoder).encode("utf-8"),
