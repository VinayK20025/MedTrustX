"""
MedTrustX Configuration Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.config.events"


class ConfigEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=ConfigEventEncoder).encode("utf-8"),
