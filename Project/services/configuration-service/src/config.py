"""
MedTrustX Configuration Service — Configuration
...
class Settings(BaseSettings):
    ...
    DB_PORT: int = 5432
    DB_USER: str = "config_svc"
    DB_PASSWORD: str = "config_svc_secret"
    DB_NAME: str = "configuration_db"
    ...
    REDIS_URL: str = "redis://redis:6379/53"
