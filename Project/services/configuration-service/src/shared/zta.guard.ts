...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'cs_resource';
    if (request.path.includes('/config/versions')) resource = 'cs_versions';
    else if (request.path.includes('/config')) resource = 'cs_config';
    else if (request.path.includes('/feature-flags')) resource = 'cs_flags';
    else if (request.path.includes('/environments')) resource = 'cs_environments';
