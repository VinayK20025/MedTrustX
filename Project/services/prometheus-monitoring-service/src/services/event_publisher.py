"""
MedTrustX Prometheus Monitoring Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.monitoring.events"


class MonitoringEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=MonitoringEventEncoder).encode("utf-8"),
