"""
MedTrustX Postal Mail Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.postal.events"


class PostalEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=PostalEventEncoder).encode("utf-8"),
