"""
MedTrustX Performance Management Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.performance.events"


class PerformanceEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=PerformanceEventEncoder).encode("utf-8"),
