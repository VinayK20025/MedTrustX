...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'pm_resource';
    if (request.path.includes('/kpis')) resource = 'pm_kpis';
    else if (request.path.includes('/performance-records')) resource = 'pm_records';
    else if (request.path.includes('/scorecards')) resource = 'pm_scorecards';
    else if (request.path.includes('/evaluations')) resource = 'pm_evaluations';
    else if (request.path.includes('/benchmarks')) resource = 'pm_benchmarks';
