"""
MedTrustX OT Management Service — Event Publisher

Publishes operational coordination events to Redpanda/Kafka.
...
async def publish_event(
    ...
    try:
        routing_key = str(surgery_id) if surgery_id else str(tenant_id)
