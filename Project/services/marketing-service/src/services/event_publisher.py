"""
MedTrustX Marketing Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.marketing.events"

class MarketingEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=MarketingEventEncoder).encode("utf-8"),
