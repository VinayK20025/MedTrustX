"""
MedTrustX Wazuh Shim Service — Application Entrypoint
"""
import time
...
REQUEST_COUNT = Counter(
    "wazuh_requests_total",
    "Total HTTP requests", ["method", "endpoint", "status"],
)
REQUEST_LATENCY = Histogram(
    "wazuh_request_duration_seconds",
...
app = FastAPI(
    title="MedTrustX Wazuh Shim Service",
...
from src.routes.siem import router as siem_router
