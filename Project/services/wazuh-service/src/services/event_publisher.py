"""
MedTrustX Wazuh Shim Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.wazuh.events"

class WazuhEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=WazuhEventEncoder).encode("utf-8"),
