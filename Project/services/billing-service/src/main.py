"""
MedTrustX Billing Service — Application Entrypoint
"""
import time
...
app = FastAPI(
    title="MedTrustX Billing Service",
    description="Financial transaction engine converting clinical activities into monetizable charges.",
...
async def metrics_middleware(request: Request, call_next):
    ...
    if "/charges" in path or "/invoices" in path or "/payments" in path or "/adjustments" in path:
        parts = path.split("/")
        normalized = []
        for part in parts:
            try:
