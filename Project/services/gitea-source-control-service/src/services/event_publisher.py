"""
MedTrustX Gitea Source Control Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.sourcecontrol.events"


class GiteaEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=GiteaEventEncoder).encode("utf-8"),
