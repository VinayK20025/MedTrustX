"""
MedTrustX Telemedicine Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.telemedicine.events"

class TeleEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=TeleEventEncoder).encode("utf-8"),
