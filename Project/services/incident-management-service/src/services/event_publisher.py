"""
MedTrustX Incident Management Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.incident.events"
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=IncidentEventEncoder).encode("utf-8"),
