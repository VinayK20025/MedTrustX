"""
MedTrustX Incident Management Service — Configuration
...
class Settings(BaseSettings):
    ...
    LOG_LEVEL: str = "debug"
    SERVICE_NAME: str = "incident-management-service"
    SERVICE_VERSION: str = "1.0.0"

    DB_HOST: str = "pg-operational"
    DB_PORT: int = 5432
    DB_USER: str = "inc_svc"
    DB_PASSWORD: str = "inc_svc_secret"
    ...
    REDIS_URL: str = "redis://redis:6379/62"
