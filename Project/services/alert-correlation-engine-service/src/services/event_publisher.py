"""
MedTrustX Alert Correlation Engine Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.alertcorrelation.events"


class CorrEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=CorrEventEncoder).encode("utf-8"),
