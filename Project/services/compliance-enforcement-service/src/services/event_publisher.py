"""
MedTrustX Compliance Enforcement Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.compliance_enforcement.events"

class EnforcementEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=EnforcementEventEncoder).encode("utf-8"),
