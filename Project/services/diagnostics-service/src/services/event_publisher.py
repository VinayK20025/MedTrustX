"""
MedTrustX Diagnostics Service — Event Publisher

Publishes domain events to Redpanda/Kafka.
...
TOPIC = "medtrust.diagnostics.events"
...
async def publish_event(
    ...
    try:
        # Key by patient_id to ensure diagnostic events for a patient stay ordered
