...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'rm_resource';
    if (request.path.includes('/risks')) resource = 'rm_risks';
    else if (request.path.includes('/mitigation-plans')) resource = 'rm_mitigations';
    else if (request.path.includes('/risk-indicators')) resource = 'rm_indicators';
