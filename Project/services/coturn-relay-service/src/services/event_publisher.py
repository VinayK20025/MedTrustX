"""
MedTrustX Coturn Relay Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.coturn.events"


class CoturnEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=CoturnEventEncoder).encode("utf-8"),
