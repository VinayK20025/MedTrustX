...
_RESOURCE_MAP = {
    "/populations": "pophealth_populations",
    "/risk-profiles": "pophealth_risk_profiles",
    "/care-gaps": "pophealth_care_gaps",
    "/interventions": "pophealth_interventions",
}
