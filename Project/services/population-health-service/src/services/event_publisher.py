"""
MedTrustX Population Health Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.pophealth.events"


class PopHealthEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=PopHealthEventEncoder).encode("utf-8"),
