"""
MedTrustX Multi-Tenant Isolation Manager Service — Database Engine & Session Factory
"""
...
engine = create_async_engine(
    settings.DATABASE_URL, pool_size=20, max_overflow=10, pool_pre_ping=True, pool_recycle=300,
    echo=settings.LOG_LEVEL == "debug", connect_args={"server_settings": {"application_name": settings.SERVICE_NAME}},
)
