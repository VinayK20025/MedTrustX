"""
MedTrustX Grafana Visualization Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.visualization.events"


class VisualizationEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=VisualizationEventEncoder).encode("utf-8"),
