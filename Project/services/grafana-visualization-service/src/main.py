"""
MedTrustX Grafana Visualization Service — Application Entrypoint
"""
import time
...
REQUEST_COUNT = Counter("grafana_visualization_requests_total", "Total HTTP requests", ["method", "endpoint", "status"])
REQUEST_LATENCY = Histogram("grafana_visualization_request_duration_seconds", "Request latency in seconds", ["method", "endpoint"])
...
app = FastAPI(
    title="MedTrustX Grafana Visualization Service",
    description="Tier-1 interface for querying and presenting operational dashboards.",
...
from src.routes.grafana import router as grafana_router
