"""
MedTrustX Compliance Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.compliance.events"

class ComplianceEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=ComplianceEventEncoder).encode("utf-8"),
