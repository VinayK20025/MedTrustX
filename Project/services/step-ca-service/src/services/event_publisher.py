"""
MedTrustX Step-CA Shim Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.pki.events"

class PKIEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=PKIEventEncoder).encode("utf-8"),
