"""
MedTrustX Resource Optimization Engine Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.optimization.events"


class OptEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=OptEventEncoder).encode("utf-8"),
