"""
MedTrustX Clinical Pathway Intelligence Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.pathway.events"


class PathwayEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=PathwayEventEncoder).encode("utf-8"),
