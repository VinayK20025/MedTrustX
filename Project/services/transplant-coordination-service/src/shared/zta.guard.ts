...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'tc_resource';
    if (request.path.includes('/donors')) resource = 'tc_donors';
    else if (request.path.includes('/recipients')) resource = 'tc_recipients';
    else if (request.path.includes('/waitlists')) resource = 'tc_waitlists';
    else if (request.path.includes('/matches')) resource = 'tc_matches';
    else if (request.path.includes('/transplant-events')) resource = 'tc_events';
