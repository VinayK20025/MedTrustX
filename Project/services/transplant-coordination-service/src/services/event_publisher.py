"""
MedTrustX Transplant Coordination Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.transplant.events"


class TransplantEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=TransplantEventEncoder).encode("utf-8"),
