"""
MedTrustX Mortuary Management Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.mortuary.events"


class MortuaryEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=MortuaryEventEncoder).encode("utf-8"),
