"""
MedTrustX Mortuary Management Service — Configuration
...
class Settings(BaseSettings):
    ...
    LOG_LEVEL: str = "debug"
    SERVICE_NAME: str = "mortuary-management-service"
    SERVICE_VERSION: str = "1.0.0"

    DB_HOST: str = "pg-operational"
    DB_PORT: int = 5432
    DB_USER: str = "mm_svc"
    DB_PASSWORD: str = "mm_svc_secret"
    DB_NAME: str = "mortuary_db"
    ...
    REDIS_URL: str = "redis://redis:6379/67"
