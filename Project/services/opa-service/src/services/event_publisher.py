"""
MedTrustX OPA Shim Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.opa.events"

class OPAEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=OPAEventEncoder).encode("utf-8"),
