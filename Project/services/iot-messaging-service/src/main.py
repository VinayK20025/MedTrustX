"""
MedTrustX IoT Messaging Service — Application Entrypoint
"""
import time
...
REQUEST_COUNT = Counter("iot_requests_total", "Total HTTP requests", ["method", "endpoint", "status"])
REQUEST_LATENCY = Histogram("iot_request_duration_seconds", "Request latency in seconds", ["method", "endpoint"])
...
app = FastAPI(
    title="MedTrustX IoT Messaging Service",
    description="Real-time device messaging and ingestion layer.",
...
from src.routes.iot import router as iot_router
