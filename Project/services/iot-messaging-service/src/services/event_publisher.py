"""
MedTrustX IoT Messaging Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.iot.events"


class IoTEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=IoTEventEncoder).encode("utf-8"),
