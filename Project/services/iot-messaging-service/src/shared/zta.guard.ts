...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'iot_resource';
    if (request.path.includes('/devices/connect')) resource = 'iot_connections';
    else if (request.path.includes('/devices')) resource = 'iot_devices';
    else if (request.path.includes('/topics')) resource = 'iot_topics';
