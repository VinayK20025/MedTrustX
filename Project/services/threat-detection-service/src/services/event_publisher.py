"""
MedTrustX Threat Detection Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.threat.events"


class ThreatEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=ThreatEventEncoder).encode("utf-8"),
