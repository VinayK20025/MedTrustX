"""
MedTrustX Facilities Service — Event Publisher

Publishes facilities lifecycle events to Redpanda/Kafka.
...
TOPIC = "medtrust.facilities.events"
...
async def publish_event(
    ...
    try:
        routing_key = str(entity_id) if entity_id else str(tenant_id)
