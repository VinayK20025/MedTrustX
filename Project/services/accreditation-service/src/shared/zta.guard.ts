...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'acc_resource';
    if (request.path.includes('/accreditation')) resource = 'acc_programs';
    else if (request.path.includes('/standards')) resource = 'acc_standards';
    else if (request.path.includes('/checklists')) resource = 'acc_checklists';
    else if (request.path.includes('/evidence')) resource = 'acc_evidence';
    else if (request.path.includes('/audits')) resource = 'acc_audits';
