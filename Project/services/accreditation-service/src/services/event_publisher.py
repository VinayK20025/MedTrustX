"""
MedTrustX Accreditation Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.accreditation.events"


class AccEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=AccEventEncoder).encode("utf-8"),
