...
export class ZtaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    let resource = 'eth_resource';
    if (request.path.includes('/cases')) resource = 'eth_cases';
    else if (request.path.includes('/reviews')) resource = 'eth_reviews';
    else if (request.path.includes('/committee')) resource = 'eth_committee';
    else if (request.path.includes('/conflicts')) resource = 'eth_conflicts';
    else if (request.path.includes('/policies')) resource = 'eth_policies';
