"""
MedTrustX Ethics Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.ethics.events"


class EthicsEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=EthicsEventEncoder).encode("utf-8"),
