"""
MedTrustX Security Incident Response Service — Configuration
"""
...
class Settings(BaseSettings):
    ...
    DB_PASSWORD: str = "incident_svc_secret"
    DB_NAME: str = "security_incident_db"
    ...
    REDIS_URL: str = "redis://redis:6379/101"
