"""
MedTrustX Clinical Research Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.research.events"


class ResearchEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=ResearchEventEncoder).encode("utf-8"),
