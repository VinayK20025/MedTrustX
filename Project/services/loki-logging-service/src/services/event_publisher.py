"""
MedTrustX Loki Logging Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.logging.events"


class LoggingEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=LoggingEventEncoder).encode("utf-8"),
