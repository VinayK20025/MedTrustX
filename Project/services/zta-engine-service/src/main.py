"""
MedTrustX ZTA Engine Service — Application Entrypoint
"""
import time
...
app = FastAPI(
    title="MedTrustX ZTA Engine Service",
    description="Dynamic, context-aware risk evaluation and access enforcement.",
...
from src.routes.risk_events import router as risk_events_router
