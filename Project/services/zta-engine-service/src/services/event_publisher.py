"""
MedTrustX ZTA Engine Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.zta.events"

class ZTAEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=ZTAEventEncoder).encode("utf-8"),
