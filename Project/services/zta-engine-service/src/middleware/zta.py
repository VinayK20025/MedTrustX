...
_RESOURCE_MAP = {
    "/zta/evaluate-access": "zta_evaluation",
    "/zta/update-context": "zta_context",
    "/zta/sessions": "zta_session",
    "/zta/risk-events": "zta_risk",
    "/zta/access-decisions": "zta_decision",
}
