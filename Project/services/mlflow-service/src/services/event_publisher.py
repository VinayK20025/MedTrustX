"""
MedTrustX MLflow Service — Event Publisher
"""
import json
...
TOPIC = "medtrust.mlflow.events"


class MLflowEventEncoder(json.JSONEncoder):
...
async def init_producer() -> None:
    ...
    try:
        _producer = AIOKafkaProducer(
            ...
            value_serializer=lambda v: json.dumps(v, cls=MLflowEventEncoder).encode("utf-8"),
