"""
MedTrustX MLflow Service — Application Entrypoint
"""
import time
...
app = FastAPI(
    title="MedTrustX MLflow Service",
    description="ML lifecycle management — experiment tracking, model registry, and stage promotion.",
...
from src.routes.mlflow import router as mlflow_router
