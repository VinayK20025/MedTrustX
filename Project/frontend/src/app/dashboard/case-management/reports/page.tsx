...
export default function CaseManagerReportsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1600px]">
      <Breadcrumbs items={[{ label: 'Case Management' }, { label: 'Case Reports' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light h-full min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Case Management Reports</p>
          <p className="text-sm">Export data on insurance denial rates and average LOS deviations.</p>
        </CardBody>
      </Card>
    </div>
  );
