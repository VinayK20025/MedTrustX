...
export default function ClaimsDocumentsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Claims Recovery' }, { label: 'Document Vault' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Document Compliance</p>
          <p className="text-sm">Verify and attach missing documentation to prevent claim rejections.</p>
        </CardBody>
      </Card>
    </div>
  );
