...
export default function ClaimsReportsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Claims Recovery' }, { label: 'Recovery Reports' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Revenue Recovery Analytics</p>
          <p className="text-sm">Analyze outstanding revenue, aging buckets, and claim success rates.</p>
        </CardBody>
      </Card>
    </div>
  );
