...
export default function ClaimsDenialsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Claims Recovery' }, { label: 'Denial Management' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Denial & Resubmission</p>
          <p className="text-sm">Analyze rejection reasons, correct errors, and process claim resubmissions.</p>
        </CardBody>
      </Card>
    </div>
  );
