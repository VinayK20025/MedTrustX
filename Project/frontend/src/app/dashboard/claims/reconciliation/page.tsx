...
export default function ClaimsReconciliationPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Claims Recovery' }, { label: 'Payment Reconciliation' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Revenue Reconciliation</p>
          <p className="text-sm">Match expected claim amounts against actual receipts and track short payments.</p>
        </CardBody>
      </Card>
    </div>
  );
