...
export default function LabTechReportsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1600px]">
      <Breadcrumbs items={[{ label: 'Laboratory' }, { label: 'Tech Reports' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light h-full min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Throughput & Shift Reports</p>
          <p className="text-sm">Export sample volumes and device utilization metrics.</p>
        </CardBody>
      </Card>
    </div>
  );
