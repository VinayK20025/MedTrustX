...
export default function PlatformScalingPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1600px]">
      <Breadcrumbs items={[{ label: 'Infrastructure' }, { label: 'Scaling & HPA' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light h-full min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Horizontal Pod Autoscaler (HPA) Tuning</p>
          <p className="text-sm">Manage CPU/Memory thresholds for automated workload scaling.</p>
        </CardBody>
      </Card>
    </div>
  );
