...
export default function TrainingProgramsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Training' }, { label: 'Program Management' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Training Program Builder</p>
          <p className="text-sm">Create, edit, and archive training programs with module definitions.</p>
        </CardBody>
      </Card>
    </div>
  );
