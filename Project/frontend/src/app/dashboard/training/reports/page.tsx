...
export default function TrainingReportsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Training' }, { label: 'Training Reports' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Training Analytics</p>
          <p className="text-sm">Completion rates, attendance trends, and certification renewal reports.</p>
        </CardBody>
      </Card>
    </div>
  );
