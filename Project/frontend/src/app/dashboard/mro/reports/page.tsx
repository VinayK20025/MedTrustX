...
export default function MroReportsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1600px]">
      <Breadcrumbs items={[{ label: 'Health Information Management' }, { label: 'HIM Reports' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light h-full min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Coding Analytics</p>
          <p className="text-sm">Export data on missing documentation rates and coding accuracy.</p>
        </CardBody>
      </Card>
    </div>
  );
