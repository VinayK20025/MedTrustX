...
export default function NetworkConfigPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'IT Administration' }, { label: 'Switch Config' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">VLANs & Routing Tables</p>
          <p className="text-sm">Manage subnet segmentation, DHCP scopes, and static routes.</p>
        </CardBody>
      </Card>
    </div>
  );
