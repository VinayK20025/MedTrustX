...
export default function TpaReportsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'TPA Desk' }, { label: 'TPA Analytics' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">TPA Performance Reports</p>
          <p className="text-sm">Analyze average approval times, rejection reasons, and insurer metrics.</p>
        </CardBody>
      </Card>
    </div>
  );
