...
export default function DischargeReportsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Patient Flow' }, { label: 'Discharge Logs' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Discharge Analytics</p>
          <p className="text-sm">Average discharge times, delay frequency, and departmental bottleneck reports.</p>
        </CardBody>
      </Card>
    </div>
  );
