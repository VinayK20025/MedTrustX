...
export default function DischargeBillingPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[900px]">
      <Breadcrumbs items={[{ label: 'Patient Flow' }, { label: 'Billing Clearance' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Billing Clearance Panel</p>
          <p className="text-sm">Track outstanding balances and approve financial clearance for discharge.</p>
        </CardBody>
      </Card>
    </div>
  );
