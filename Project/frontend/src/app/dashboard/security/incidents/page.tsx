...
export default function SecurityIncidentsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Security' }, { label: 'Incidents' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Security Incident Log</p>
          <p className="text-sm">Track, respond to, and close unauthorized access, theft, and emergency reports.</p>
        </CardBody>
      </Card>
    </div>
  );
