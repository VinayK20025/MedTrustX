...
export default function SecurityReportsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Security' }, { label: 'Security Reports' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Incident Analytics & Audits</p>
          <p className="text-sm">Analyze incidents by zone, peak hours, response times, and guard efficiency.</p>
        </CardBody>
      </Card>
    </div>
  );
