...
export default function SecurityStaffPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Security' }, { label: 'Guard Management' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Guards & Patrol Routes</p>
          <p className="text-sm">Manage shift schedules, patrol assignments, and real-time guard tracking.</p>
        </CardBody>
      </Card>
    </div>
  );
