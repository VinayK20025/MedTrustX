...
export default function CctvCamerasPage() {
  return (
    <div className="space-y-5 animate-fade-in">
      <Breadcrumbs items={[{ label: 'Security' }, { label: 'All Cameras' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Camera Directory</p>
          <p className="text-sm">Full list of all cameras including zones, resolutions, and maintenance status.</p>
        </CardBody>
      </Card>
    </div>
  );
