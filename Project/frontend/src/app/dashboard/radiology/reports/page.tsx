...
export default function RadiologyReportsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1600px]">
      <Breadcrumbs items={[{ label: 'Diagnostics' }, { label: 'Finalized Reports' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light h-full min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Completed Radiology Reports</p>
          <p className="text-sm">Review signed impressions and findings exported to the EHR.</p>
        </CardBody>
      </Card>
    </div>
  );
