...
export default function InsurancePreAuthPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Insurance' }, { label: 'Pre-Authorizations' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Pre-Authorization Requests</p>
          <p className="text-sm">Track pre-auth requests and approvals prior to treatment.</p>
        </CardBody>
      </Card>
    </div>
  );
