...
export default function InsuranceReconciliationPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Insurance' }, { label: 'Payment Reconciliation' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Payment Reconciliation</p>
          <p className="text-sm">Match claim payments, track settlements, and resolve financial discrepancies.</p>
        </CardBody>
      </Card>
    </div>
  );
