...
export default function OperationsReportsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Operations' }, { label: 'Operations Reports' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Command Center Analytics</p>
          <p className="text-sm">Historical trends on hospital throughput, incident resolutions, and occupancy.</p>
        </CardBody>
      </Card>
    </div>
  );
