...
export default function OperationsResourcesPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Operations' }, { label: 'Equipment & Resources' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Resource Utilization</p>
          <p className="text-sm">Monitor critical equipment availability (Ventilators, MRIs) and downtimes.</p>
        </CardBody>
      </Card>
    </div>
  );
