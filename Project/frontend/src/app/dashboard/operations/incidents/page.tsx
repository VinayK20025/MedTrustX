...
export default function OperationsIncidentsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Operations' }, { label: 'Incident Management' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Escalations & Incidents</p>
          <p className="text-sm">Track, assign, and resolve hospital-wide operational disruptions.</p>
        </CardBody>
      </Card>
    </div>
  );
