...
export default function HelpdeskReportsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Administration' }, { label: 'Helpdesk Reports' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Support Analytics</p>
          <p className="text-sm">Analyze ticket volumes, department performance, and SLA compliance metrics.</p>
        </CardBody>
      </Card>
    </div>
  );
