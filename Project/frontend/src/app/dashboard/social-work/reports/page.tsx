...
export default function SocialWorkerReportsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1600px]">
      <Breadcrumbs items={[{ label: 'Social Work' }, { label: 'Social Work Reports' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light h-full min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Social Work Reporting</p>
          <p className="text-sm">Export data on community resource utilization and high-risk case volume.</p>
        </CardBody>
      </Card>
    </div>
  );
