...
export default function AccountsLedgerPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'Finance' }, { label: 'General Ledger' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">General Ledger & AP/AR</p>
          <p className="text-sm">Ledger entries, accounts payable/receivable, and vendor management.</p>
        </CardBody>
      </Card>
    </div>
  );
