...
export default function ItInfraPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'IT Administration' }, { label: 'Infrastructure' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Server & Network Telemetry</p>
          <p className="text-sm">Track CPU loads, memory usage, and load balancer configurations.</p>
        </CardBody>
      </Card>
    </div>
  );
