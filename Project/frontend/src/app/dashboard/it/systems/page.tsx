...
export default function ItSystemsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'IT Administration' }, { label: 'Core Systems' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">HIS / EMR / LIS Monitoring</p>
          <p className="text-sm">Manage uptimes and service disruptions across main hospital systems.</p>
        </CardBody>
      </Card>
    </div>
  );
