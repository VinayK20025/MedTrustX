...
export default function ItSecurityPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1200px]">
      <Breadcrumbs items={[{ label: 'IT Administration' }, { label: 'Security' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Cybersecurity & Access Logs</p>
          <p className="text-sm">Monitor unauthorized login attempts, firewall logs, and security threats.</p>
        </CardBody>
      </Card>
    </div>
  );
