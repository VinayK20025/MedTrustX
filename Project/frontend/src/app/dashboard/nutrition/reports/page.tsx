...
export default function NutritionReportsPage() {
  return (
    <div className="space-y-5 animate-fade-in max-w-[1600px]">
      <Breadcrumbs items={[{ label: 'Clinical Nutrition' }, { label: 'Nutrition Reports' }]} />
      <Card className="border-white/[0.06] shadow-glass bg-surface-light h-full min-h-[400px] flex items-center justify-center">
        <CardBody className="text-gray-500 text-center">
          <p className="text-lg">Nutrition Reports Module</p>
          <p className="text-sm">Export intake summaries and dietary compliance logs.</p>
        </CardBody>
      </Card>
    </div>
  );
