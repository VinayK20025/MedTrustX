...
import type { SpeechTherapyPlan } from '../types/speech.types';
import { MessageSquare, Target, Clock, Settings2 } from 'lucide-react';

interface Props { plan?: SpeechTherapyPlan; }

export function SpeechTherapyPanel({ plan }: Props) {
    ...
    <Card className="border-white/[0.06] shadow-glass bg-surface-light h-full flex flex-col">
      <CardHeader className="border-b border-white/[0.04] px-5 py-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="p-2 rounded-lg bg-orange-500/15"><MessageSquare className="w-4 h-4 text-orange-400" /></div>
          <div>
      ...
      <CardBody className="p-5 flex-1 overflow-y-auto max-h-[450px]">
        ...
        <div>
          <h4 className="text-[11px] font-bold text-gray-500 uppercase flex items-center gap-1.5 mb-3"><MessageSquare className="w-3.5 h-3.5" /> Cognitive Exercises</h4>
